...
struct CBMaterial
{
    ...
    XMFLOAT4 Albedos[PRayTracer::NUM_MESH];
};

const wchar_t* PRayTracer::HitGroupNames[] = { L"hitGroupRadiance", L"hitGroupShadow" };
const wchar_t* PRayTracer::RaygenShaderName = L"raygenMain";
const wchar_t* PRayTracer::ClosestHitShaderNames[] = { L"closestHitRadiance", L"closestHitShadow" };
const wchar_t* PRayTracer::MissShaderNames[] = { L"missRadiance", L"missShadow" };
