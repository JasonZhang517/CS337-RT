...
//void PostProcessor::Denoise(const CommandList* pCommandList, uint32_t numBarriers,
...
bool PostProcessor::createPipelines(Format rtFormat)
{
	...
	// Tone mapping
	{
		...
		N_RETURN(m_shaderPool->CreateShader(Shader::Stage::PS, psIndex, L"PSToneMapNew.cso"), false);
...
//void PostProcessor::reflectionSpatialFilter(const CommandList* pCommandList, uint32_t numBarriers,
//	ResourceBarrier* pBarriers)
//{
//	// Horizontal pass
//	{
...
//void PostProcessor::diffuseSpatialFilter(const CommandList* pCommandList, uint32_t numBarriers,
//	ResourceBarrier* pBarriers)
//{
//	// Horizontal pass
//	{
...
//void PostProcessor::temporalSS(const CommandList* pCommandList)
//{
